...
import 'package:pacman/pages/SplashScreen.dart';
import 'package:pacman/pages/login_page.dart';
import 'package:pacman/pages/widgets/header_widget.dart';
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  SizedBox(height: 20,),
                  Text('Lasmar Nesrine', style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold),),
                  SizedBox(height: 20,),
                  Text('Ingénieur GL', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold),),
                  SizedBox(height: 10,),
                  Container(
                    padding: EdgeInsets.all(10),
                    child: Column(
                                    ...
                                    ...ListTile.divideTiles(
                                      ...
                                      tiles: [
                                        ListTile(
                                          ...
                                          title: Text("Location"),
                                          subtitle: Text("Tunisie"),
                                        ),
                                        ListTile(
                                          leading: Icon(Icons.email),
                                          title: Text("Email"),
                                          subtitle: Text("nesrine.lasmar@gmail.com"),
                                        ),
                                        ListTile(
                                          leading: Icon(Icons.phone),
                                          title: Text("Phone"),
                                          subtitle: Text("88888888"),
                                        ),
                                        ListTile(
